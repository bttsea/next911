...
class Router {
    constructor(pathname, query, as, { initialProps, pageLoader, App, wrapApp, Component, err, subscription, }) {
        this.onPopState = (e) => {
            if (!e.state) {
                ...
                this.changeState('replaceState', (0, utils_1.formatWithValidation)({ pathname, query }), (0, utils_1.getURL)());
                return;
            }
        ...
        this.asPath =
            ...
            (0, is_dynamic_1.isDynamicRoute)(pathname) && __NEXT_DATA__.nextExport ? pathname : as;
        ...
        if (typeof window !== 'undefined') {
            ...
            this.changeState('replaceState', (0, utils_1.formatWithValidation)({ pathname, query }), as);
            ...
            window.addEventListener('unload', () => {
                ...
                if (history.state) {
                    ...
                    this.changeState('replaceState', url, as, Object.assign(Object.assign({}, options), { fromExternal: true }));
                }
            });
        }
    }
    ...
    static _rewriteUrlForNextExport(url) {
        return (0, rewrite_url_for_export_1.rewriteUrlForNextExport)(url);
    }
    update(route, mod) {
    ...
    change(method, _url, _as, options) {
        return new Promise((resolve, reject) => {
            ...
            const url = typeof _url === 'object' ? (0, utils_1.formatWithValidation)(_url) : _url;
            let as = typeof _as === 'object' ? (0, utils_1.formatWithValidation)(_as) : _as;
            // Add the ending slash to the paths. So, we can serve the
            // "<page>/index.html" directly for the SSR page.
            if (process.env.__NEXT_EXPORT_TRAILING_SLASH) {
                // @ts-ignore this is temporarily global (attached to window)
                if (__NEXT_DATA__.nextExport) {
                    as = (0, rewrite_url_for_export_1.rewriteUrlForNextExport)(as);
                }
            }
            ...
            const { pathname, query, protocol } = (0, url_1.parse)(url, true);
            ...
            if ((0, is_dynamic_1.isDynamicRoute)(route)) {
                const { pathname: asPathname } = (0, url_1.parse)(as);
                const rr = (0, route_regex_1.getRouteRegex)(route);
                const routeMatch = (0, route_matcher_1.getRouteMatcher)(rr)(asPathname);
                if (!routeMatch) {
    ...
    prefetch(url) {
        return new Promise((resolve, reject) => {
            const { pathname, protocol } = (0, url_1.parse)(url);
            if (!pathname || protocol) {
                if (process.env.NODE_ENV !== 'production') {
                    throw new Error(`Invalid href passed to router: ${url} https://err.sh/zeit/next.js/invalid-href-passed`);
                }
    ...
    async getInitialProps(Component, ctx) {
        ...
        (self.__HAS_SPR || process.env.NODE_ENV !== 'production') &&
            ...
            let status;
            const { pathname } = (0, url_1.parse)(ctx.asPath || ctx.pathname);
            ...
            ctx.AppTree = AppTree;
            props = await (0, utils_1.loadGetInitialProps)(App, {
                AppTree,
                Component,
                router: this,
                ctx,
