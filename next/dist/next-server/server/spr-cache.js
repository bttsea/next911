...
exports.setSprCache = exports.getSprCache = exports.initializeSprCache = exports.calculateRevalidate = void 0;
...
async function getSprCache(pathname) {
    if (sprOptions.dev)
        return;
    pathname = (0, normalize_page_path_1.normalizePagePath)(pathname);
    ...
    if (!data) {
        try {
            ...
            data = {
                html,
                pageData,
                revalidateAfter: (0, exports.calculateRevalidate)(pathname),
            };
...
async function setSprCache(pathname, data, revalidateSeconds) {
    ...
    pathname = (0, normalize_page_path_1.normalizePagePath)(pathname);
    cache.set(pathname, Object.assign(Object.assign({}, data), { revalidateAfter: (0, exports.calculateRevalidate)(pathname) }));
