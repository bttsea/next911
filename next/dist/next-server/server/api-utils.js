...
exports.setLazyProp = exports.sendError = exports.ApiError = exports.sendJson = exports.sendData = exports.sendStatusCode = exports.getCookieParser = exports.getQueryParser = exports.parseBody = exports.apiResolver = void 0;
...
async function apiResolver(req, res, params, resolverModule) {
    try {
        ...
        const resolver = (0, load_components_1.interopDefault)(resolverModule);
        resolver(req, res);
    }
    catch (e) {
...
async function parseBody(req, limit) {
    const contentType = (0, content_type_1.parse)(req.headers['content-type'] || 'text/plain');
    const { type, parameters } = contentType;
    const encoding = parameters.charset || 'utf-8';
    let buffer;
    try {
        buffer = await (0, raw_body_1.default)(req, { encoding, limit });
    }
    catch (e) {
